      ...
      return prev.map(item => {
        ...
        if (updateSignal.updatedType === "page") {
          return {
            ...
            active: updateSignal.updatedActive ?? item.active,
            useRole: updateSignal.updatedUseRole ?? item.useRole,
            can_view_by: updateSignal.updatedCanViewBy || item.can_view_by
          };
        }
